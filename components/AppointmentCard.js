    ...
    return (
      <View style={styles.container}>
        <View style={styles.dateContainer}>
          <View
            style={[styles.topLine, firstEntry ? {} : styles.lineVisible]}
          />
          {date == undefined ? (
            <View style={styles.dot} />
          ) : (
            <Text
              style={[styles.date, date == 'JETZT' ? { color: '#316597' } : {}]}
            >
              {date}
            </Text>
          )}
          ...
          <View
            style={[styles.bottomLine, lastEntry ? {} : styles.lineVisible]}
          />
        </View>
